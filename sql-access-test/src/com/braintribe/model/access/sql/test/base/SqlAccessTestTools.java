 ...
 * @author peter.gazdik
 */
public class SqlAccessTestTools {

	public static DataSource deploy(HikariCpConnectionPool connectionPool) {
		// return PooledDataSources.dataSource(connectionPool)
