 ...
 * @author peter.gazdik
 */
public interface BasicEntity extends SqlAccessEntity {
	...
	LocalizedString getLocalizedStringValue();
	void setLocalizedStringValue(LocalizedString localizedStringValue);

	BasicEntity getBasicEntity();
	void setBasicEntity(BasicEntity basicEntity);
